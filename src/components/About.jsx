      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-gray-600 leading-relaxed mb-8">
            I am a versatile fullstack software engineer with expertise in Django and React
            development, machine learning, and data analysis. Proficient in
            Python, Javascript, Wordpress, SQL and Database management, I enjoy building practical
          ...
          <div className="grid grid-cols-4 md:grid-cols-4 gap-8 mt-16">
            ...
            <div className="p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">
                Building responsive and interactive user interfaces with React and Tailwind CSS
              </p>
            </div>
